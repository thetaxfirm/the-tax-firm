...
- The app no longer depends on any Manus / "Forge" service. The former
  `BUILT_IN_FORGE_*`, `VITE_FRONTEND_FORGE_*`, `OAUTH_SERVER_URL`,
  `VITE_OAUTH_PORTAL_URL`, and `VITE_APP_ID` variables are obsolete and can be removed.
